...
def run_tests(parent_dir: str, labels_file_name: str, image_parent_dir: str, generate_labels,
    ...
    """
    Runs OCR imprint prediction accuracy testing for the PyTesseract library.
    ...
    output_file = os.path.join(parent_dir, "output",
                               f"tesseract_accuracy_{labels_file_name[0:-4]}{sample_display}_distance.csv")
...
if __name__ == "__main__":
    # Specify location of Tesseract installation
