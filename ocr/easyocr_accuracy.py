...
def run_tests(parent_dir: str, labels_file_name: str, image_parent_dir: str, generate_labels,
    ...
    """
    Runs OCR imprint prediction accuracy testing for the EasyOCR library.
    ...
    ocr = predict.generate_ocr(model_path=r"E:\NoBackup\DGMD_E-14_FinalProject\ocr\models")
    ...
    output_file = os.path.join(parent_dir, "output",
                               f"easyocr_accuracy_{labels_file_name[0:-4]}{sample_display}_distance.csv")
